...
- **Pairing + sync settings are sensitive settings**: Ed25519 device identities, QR + human-verified SAS pairing, per-peer command permissions, per-category sync toggles, Unpair = a revocation record that propagates through the mesh.
