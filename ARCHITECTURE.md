...
├── apps/macosApp/         macOS desktop application (Compose Desktop, JVM) — planned (4-way track split, Phase 0 scaffolding; Track M body)
├── apps/iosApp/           iOS application (Compose Multiplatform iOS, shared UI) — planned (4-way track split, Phase 0 scaffolding; Track I body)
