...
├── apps/iosApp/           iOS application (Compose Multiplatform iOS, shared UI) — planned (4-way track split, Phase 0 scaffolding; Track I body) — sync BLOCKED on the Room native driver + Keychain/CommonCrypto actuals + Bonjour/Multipeer transport
