...
object FileIndexer {
    ...
    private fun scanMediaStore(context: Context, db: AegisDatabase, sinceMs: Long) {
    ...
    private fun scheduleHashAndDedup(context: Context, db: AegisDatabase, fileId: Long, path: String, mime: String) {
        ResourceGovernor.fire("hash-$fileId", ResourceClass.LIGHT, JobPriority.P3_INDEXING) {
            ...
            val existing = db.fileDao().byPath(path) ?: return@fire
    ...
    fun runTextExtraction(context: Context, db: AegisDatabase, limit: Int = 20) {
    ...
    fun runEntityExtraction(db: AegisDatabase, limit: Int = 20) {
    ...
    fun runVisualIndexing(context: Context, db: AegisDatabase, limit: Int = 20) {
    ...
    private fun registerInGraph(db: AegisDatabase, fileId: Long, path: String, mime: String) {
